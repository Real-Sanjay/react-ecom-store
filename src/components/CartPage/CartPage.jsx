...
const CartPage = () => {
  ...
  const { cart, dispatch, updateCartQuantity, deleteProductFromCart } =
        ...
        <>
          <section className="align-items cart_page">
            <div className="user_profile align-items">
              <img
                src={`https://cartwish-backend-rjnx.onrender.com/profile/${user?.profilePic}`}
                alt="profile pic"
            ...
            <button onClick={() => checkout()} className="checkout_btn">
              CheckOut
            </button>
          </section>
        </>
